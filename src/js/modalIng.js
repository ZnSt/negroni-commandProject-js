    ...
    .map(({ strIngredient, strType, strABV, strAlcohol, strDescription }) => {
      ...
      return `<div class="modalw2">
            <div class="modalw2__p modalw2__border">
                <h2 class="modalw2__title">${defaultCheck(strIngredient)}</h2>
            ...
            <h3 class="modalw2__title-second">${defaultCheck(
              strType
            )}</h3></div>
            <div class="modalw2__p scroll">
                <p class="modalw2__text"><span class="modalw2__span">${defaultCheck(
                  strIngredient
                )}</span> ${defaultCheck(strDescription)}</p>
                <ul class="modalw2__list">
                <li class="modalw2__item">&#10038 Alcohol: ${defaultCheck(
                  strAlcohol
                )}</li>
                <li class="modalw2__item">&#10038 Alcohol by volume: ${defaultCheck(
                  strABV
                )}</li>
            </ul>
            <div class="modalw2--blockbutton--add">
              <button class="modalw2--button--add" type="button">${
                ingredientCheck ? 'Remove from favorite' : 'Add to favorite'
              }</button>
              </div>
            </div>
            </div>`;
